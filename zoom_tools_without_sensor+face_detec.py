...
face_cascade_path = 'usr/local/Cellar/opencv/4.5.3_1/share/opencv4/haarcascades/haarcascade_frontalface_default.xml'
eye_cascade_path = 'usr/local/Cellar/opencv/4.5.3_1/share/opencv4/haarcascades/haarcascade_eye.xml'
...
def mesen():
    ...
    while key != 27:
        ...
        faces = face_cascade.detectMultiScale(gray) #顔の検出
